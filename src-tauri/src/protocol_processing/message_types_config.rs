...
/// 车辆信息协议配置（新协议 87 字节：XY 后增加 Z，朝向从 DOUBLE 改为四元数）
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct VehicleInfoProtocolConfig {
    ...
    pub position_z_offset: usize,
    pub quat_x_offset: usize,
    pub quat_y_offset: usize,
    pub quat_z_offset: usize,
    pub quat_w_offset: usize,
...
pub fn get_message_types_config() -> MessageTypesConfig {
    ...
    MessageTypesConfig {
        ...
        vehicle_info_protocol: VehicleInfoProtocolConfig {
            ...
            battery_offset: 65,
            gear_offset: 73,
            steering_angle_offset: 74,
            nav_status_offset: 82,
            camera_status_offset: 83,
            lidar_status_offset: 84,
            gyro_status_offset: 85,
            parking_slot_offset: 86,
            total_size: 87,
            min_speed: 0.0,
            max_speed: 1.0,
        },
